! function(e, r) {
    ...
    return function(e) {
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.orientMoves = r.getRotationFromTo = r.getFaceFromDirection = r.getDirectionFromFaces = r.normalizeNotations = r.transformNotations = r.getFaceMatchingMiddle = r.getMiddleMatchingFace = r.getMoveOfFace = r.getFaceOfMove = void 0;
        var c = t(7),
            s = function(e) {
            ...
            d = r.transformNotations = function(e) {
                var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    t = y(e);
                return r.upperCase && (t = t.map(function(e) {
                    return e[0].toUpperCase() + e.slice(1)
                })), r.orientation && (t = w(t, r.orientation)), r.reverse && (t = u(t)), "string" == typeof e ? t.join(" ") : t
            },
            y = r.normalizeNotations = function(e) {
                return "string" == typeof e && (e = e.split(" ")), e = e.filter(function(e) {
                    return "" !== e
                }), e.map(function(e) {
            ...
            b = r.getFaceFromDirection = function(e, r, t) {
                ...
                var s = new l.Face(r),
                    ...
                    m = v.axis,
                    h = v.angle;
                return u.rotate(m, h), a([u], c.map(function(e) {
        ...
        r.default = {
            getFaceOfMove: m,
            getMoveOfFace: h,
            getMiddleMatchingFace: p,
            getFaceMatchingMiddle: g,
            transformNotations: d,
            normalizeNotations: y,
            getDirectionFromFaces: P,
            getRotationFromTo: F,
            getFaceFromDirection: b,
            orientMoves: w
        }
    }, function(e, r, t) {
        "use strict";
                ...
                return i(e, null, [{
                    ...
                    value: function(e) {
                        ...
                        var r = void 0,
                            ...
                            n = void 0,
                            i = void 0;
                        if ("f" === e) r = "Y", t = "X", o = -1, n = 1, i = this._cubies.filter(function(e) {
                            return 1 === e.getZ()
                        });
                        else if ("r" === e) r = "Y", t = "Z", o = -1, n = -1, i = this._cubies.filter(function(e) {
                            return 1 === e.getX()
                        });
                        else if ("u" === e) r = "Z", t = "X", o = 1, n = 1, i = this._cubies.filter(function(e) {
                            return 1 === e.getY()
                        });
                        else if ("d" === e) r = "Z", t = "X", o = -1, n = 1, i = this._cubies.filter(function(e) {
                            return -1 === e.getY()
                        });
                        else if ("l" === e) r = "Y", t = "Z", o = -1, n = 1, i = this._cubies.filter(function(e) {
                            return -1 === e.getX()
                        });
                        else if ("b" === e) r = "Y", t = "X", o = -1, n = -1, i = this._cubies.filter(function(e) {
                            return -1 === e.getZ()
                        });
                    ...
                    value: function(e) {
                        ...
                        return e = e.toLowerCase(), {
                            axis: this._notationToRotation[e].axis,
                            mag: this._notationToRotation[e].mag * Math.PI / 2
                        }
                    }
                }, {
                    ...
                    value: function(e) {
                        e = e[0].toLowerCase();
                        var r = void 0;
                        return "m" === e ? r = ["left", "right"] : "e" === e ? r = ["up", "down"] : "s" === e && (r = ["front", "back"]), this._cubies.filter(function(e) {
            ...
            u = function() {
                ...
                return n(e, [{
                    ...
                    value: function() {
                        ...
                        var r = e.corner,
                            t = e.edge;
                        return this.partition.caseNumber = this._getCaseNumber({
                            corner: r,
                            edge: t
                        }), this._solveCase(this.partition.caseNumber, {
                            corner: r,
                            edge: t
                        }), this.partition.moves = this.totalMoves, this.totalMoves = [], this._overrideAfterEach || this._triggerAfterEach(this.partition, this.phase), this.partition
                    }
                }, {
                    key: "_solveCase",
                    value: function(e) {
        ...
        var i = function() {
            ...
            d = function() {
                ...
                return i(e, null, [{
                    key: "FromString",
                    value: function(r) {
                        return new e(r.split(" ").map(function(e) {
                            return parseInt(e)
                        }))
                    }
                }, {
                    ...
                    key: "set",
                    value: function(e) {
                        void 0 !== e && (this.vector = e.map(function(e) {
                            return Math.round(e)
                        }))
                    }
                }, {
            ...
            u = function() {
                function e(r) {
                    var t = this,
                        ...
                        i = r.colorMap,
                        a = void 0 === i ? {} : i;
                    o(this, e), this.position(n), this.colorMap = {}, Object.keys(a).forEach(function(e) {
                        var r = a[e];
                        t.colorFace(e, r)
                    })
                }
                return n(e, null, [{
                    ...
                    value: function(e) {
                        var r = this;
                        return e = e.toLowerCase(), Object.keys(this.colorMap).find(function(t) {
                    ...
                    value: function(e, r) {
                        ...
                        this.colorMap = {}, Object.keys(o).forEach(function(e) {
                ...
                return i(r, e), a(r, [{
                    ...
                    value: function(e) {
                        ...
                        var t = r.getFaceOfColor("u"),
                            o = r.getFaceOfColor(r.colors().find(function(e) {
                                return "u" !== e
                            })),
                            n = (0, s.getDirectionFromFaces)(t, o, {
                                up: "up"
                            });
            ...
            f = function(e) {
                ...
                return i(r, e), a(r, [{
                    ...
                    value: function(e) {
                        ...
                        return "down" === t.getFaceOfColor(o) && "back" === (0, s.getDirectionFromFaces)(r.getFaceOfColor(o), t.getFaceOfColor(r.getColorOfFace("down")), {
                            up: "up"
                        })
                    }
                }, {
                    ...
                    value: function(e) {
                        ...
                        var o = t.colors().find(function(e) {
                            ...
                            n = "left" === (0, s.getDirectionFromFaces)(t.getFaceOfColor(o), r.getFaceOfColor("u"), {
                                up: "down"
                            }),
                            i = (0, s.getFaceOfMove)(o),
                            a = r.getFaceOfColor(o),
                            u = (0, s.getFaceFromDirection)(i, n ? "left" : "right", {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        ...
                        var o = t.colors().find(function(e) {
                            ...
                            n = "LEFT" === (0, s.getDirectionFromFaces)(r.getFaceOfColor("u"), t.getFaceOfColor(o), {
                                up: "down"
                            }).toUpperCase(),
        ...
        var u = function() {
            ...
            p = function(e) {
                function r() {
                    ...
                    return u.subCaseOptions = Object.assign(u.options, {
                ...
                return a(r, e), u(r, [{
                    ...
                    value: function() {
                        var e = this;
                        return this.partitions = [], this.getAllPairs().forEach(function(r) {
                            var t = r.corner,
                                o = r.edge,
                                n = e._solve({
                                    corner: t,
                    ...
                    value: function() {
                        var e = this.cube.corners().filter(function(e) {
                            ...
                            i = void 0;
                        try {
                            for (var a, u = r[Symbol.iterator](); !(o = (a = u.next()).done); o = !0) ! function() {
                                var r = a.value,
                                    o = e.find(function(e) {
                                        var t = r.colors();
                    ...
                    value: function(e) {
                        ...
                        if (!this.isPairSolved({
                            ...
                            var i = r.faces().filter(function(e) {
                                ...
                                a = (0, m.getDirectionFromFaces)(i[0], i[1], {
                                    up: "down"
                                }),
                                u = "right" === a ? i[1] : i[0];
                            this.move(u + " D " + h(u), {
            ...
            v = function(e) {
                ...
                return a(r, e), c(r, [{
                    ...
                    value: function() {
                        var e = this,
                            r = [];
                        return this._getOllCubies().forEach(function(t) {
                    ...
                    value: function(e) {
                        ...
                        var r = e.faces().filter(function(e) {
                            ...
                            o = t[0],
                            n = t[1],
                            i = (0, l.getDirectionFromFaces)(o, n, {
                                up: "down"
                            }),
                            a = "right" === i ? n : o;
                    ...
                    value: function() {
                        for (var e = [], r = this._getPllCubies(), t = ["front", "left", "back", "right"], o = 0; o < r.length; o++) {
                            ...
                            var c = i.getColorOfFace(a),
                                ...
                                v = (0, l.getDirectionFromFaces)(s, f, {
                                    up: "down"
                                });
        ...
        Object.defineProperty(r, "__esModule", {
            value: !0
        }), r.algorithmShortener = r.PLLSolver = r.OLLSolver = r.F2LSolver = r.CrossSolver = r.RubiksCube = r.Cubie = r.Solver = void 0;
        var o = t(9);
        ...
        var l = t(33);
        r.Solver = l.Solver, r.default = function(e) {
            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                t = new l.Solver(e, r);
        ...
        (function(e) {
            function r() {
                ...
                return e.colors.grey = e.colors.gray, Object.keys(e).forEach(function(r) {
                    var t = e[r];
                ...
                return i(e, [{
                    ...
                    value: function() {
                        ...
                        for (var r = void 0, t = void 0, o = void 0; this.temp.length > 0;) {
                            ...
                            1 !== this.temp.length ? (this.options.compare(this.temp[0], this.temp[1]) ? function() {
                                void 0 !== i && e.input.splice(i, 1);
                                var o = e.options.combine(e.temp[0], e.temp[1]);
                                n(function() {
                                    r = "Combining:", t = o
                                }), e.temp = e.options.cancel(o) ? [] : [o], e.populateTempBackward(), 0 === e.temp.length && e.populateTempForward()
                            }() : (this.output.push(this.temp.shift()), void 0 !== i && (i > 0 ? this.temp = this.input.splice(0, 1) : this.input.splice(i, 1)), n(function() {
                                return r = "Skipping:"
                            })), n(function() {
                            ...
                            })) : (this.output.push(this.temp.pop()), this.populateTempForward(), n(function() {
        ...
        (function(r) {
            ...
            var m = function() {
                    ...
                    return Object.keys(u).forEach(function(r) {
                        u[r].closeRe = new RegExp(a(u[r].close), "g"), e[r] = {
                            get: function() {
            ...
            }()), e.exports = new o, e.exports.styles = u, e.exports.hasColor = s, e.exports.stripColor = c, e.exports.supportsColor = l
        }).call(r, t(8))
    }, function(e, r, t) {
        "use strict";
        var o = /[|\\{}()[\]^$+*?.]/g;
        ...
        (function(r) {
            ...
            e.exports = function() {
                return "FORCE_COLOR" in r.env || !(n("no-color") || n("no-colors") || n("color=false")) && (!!(n("color") || n("colors") || n("color=true") || n("color=always")) || !(r.stdout && !r.stdout.isTTY) && ("win32" === r.platform || ("COLORTERM" in r.env || "dumb" !== r.env.TERM && !!/^screen|^xterm|^vt100|color|ansi|cygwin|linux/i.test(r.env.TERM))))
            }()
        }).call(r, t(8))
    }, function(e, r, t) {
        "use strict";
        ...
        var i = function() {
            ...
            m = function() {
                function e(r, t) {
                    ...
                    this.options = t, this.phases = ["cross", "f2l", "oll", "pll"], this.progress = {}, this.phases.forEach(function(e) {
                        return o.progress[e] = []
                    });
                    var i = function(e, r) {
                        o._updateProgress(e, r)
                    };
                    this.currentPhase = null, this.currentSolver = null, this.crossSolver = new u.CrossSolver(this.cube, this.options), this.f2lSolver = new c.F2LSolver(this.cube, this.options), this.ollSolver = new s.OLLSolver(this.cube, this.options), this.pllSolver = new l.PLLSolver(this.cube, this.options), this.afterEach("all", i)
                }
                return i(e, [{
                    key: "afterEach",
                    value: function(e, r) {
                    ...
                    key: "solve",
                    value: function() {
                        this.currentPhase = "cross", this.currentSolver = this.crossSolver, this.crossSolver.solve(), this.currentPhase = "f2l", this.currentSolver = this.f2lSolver, this.f2lSolver.solve(), this.currentPhase = "oll", this.currentSolver = this.ollSolver, this.ollSolver.solve(), this.currentPhase = "pll", this.currentSolver = this.pllSolver, this.pllSolver.solve()
                    }
                }, {
                    key: "getMoves",
                    value: function() {
                        var e = this,
                            r = [];
                        return Object.keys(this.progress).forEach(function(t) {
                            e.progress[t].forEach(function(e) {
                                var t;
                                return (t = r).push.apply(t, o(e.moves))
                            })
                        }), r = (0, f.normalizeNotations)(r), r.join(" ")
                    }
                }, {
                    key: "getPartitions",
                    value: function() {
                    ...
                    value: function(e) {
                        var r = e.corner,
                            t = e.edge;
                        return this.f2lSolver.isPairSolved({
                            corner: r,
                            edge: t
                        })
                    }
            ...
            f = function(e) {
                ...
                return i(r, e), a(r, [{
                    ...
                    value: function(e) {
                        var r = e.corner,
                            t = e.edge;
                        return this.solveSeparatedPair({
                            corner: r,
                            edge: t
                        })
                    }
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            i = (0, s.getFaceFromDirection)(n, "back", {
                                up: "down"
                            }),
                            a = r.getFaceOfColor(t.getColorOfFace("down")),
                            u = "left" === (0, s.getFaceFromDirection)(o, a, {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            a = "left" === (0, s.getFaceFromDirection)(i, o, {
                                up: "down"
                            }),
                            u = (0, s.getRotationFromTo)("down", o, n),
                            c = (0, s.getMoveOfFace)(n);
                        c = a ? l(c) : c, this.move(u + " " + c + " D D " + l(c), {
                            upperCase: !0
                        }), this.solveSeparatedPair({
                            corner: r,
                            edge: t
                        })
                    }
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            i = "right" === (0, s.getFaceFromDirection)((0, s.getFaceOfMove)(o), (0, s.getFaceOfMove)(n), {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            a = "left" === (0, s.getDirectionFromFaces)(n, r.getFaceOfColor(o), {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            i = (0, s.getFaceOfMove)(o),
                            a = "left" === (0, s.getDirectionFromFaces)(r.getFaceOfColor(o), r.getFaceOfColor("u"), {
                                up: "down"
                            }),
                            u = (0, s.getRotationFromTo)("down", n, i);
                        this.move(u, {
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            a = (0, s.getFaceOfMove)(o),
                            u = "left" === (0, s.getDirectionFromFaces)(i, r.getFaceOfColor("u"), {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            n = r.getFaceOfColor("u"),
                            i = (0, s.getFaceOfMove)(o),
                            a = "left" === (0, s.getDirectionFromFaces)(r.getFaceOfColor(o), n, {
                                up: "down"
                            }),
                            u = (0, s.getRotationFromTo)("down", n, i),
                            c = a ? i : l(i);
                        this.move(u + " " + c + " D D " + l(c), {
                            upperCase: !0
                        }), this.solveSeparatedPair({
                            corner: r,
                            edge: t
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            u = "left" === (0, s.getDirectionFromFaces)(r.getFaceOfColor(n), r.getFaceOfColor("u"), {
                                up: "down"
                            }),
                            c = (0, s.getRotationFromTo)("down", i, a);
                        this.move(c, {
                ...
                return i(r, e), u(r, [{
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            n = t.faces(),
                            i = (0, l.getDirectionFromFaces)(o[0], o[1], {
                                up: "down"
                            }),
                            a = (0, l.getDirectionFromFaces)(n[0], n[1], {
                                up: "down"
                            }),
                            u = "right" === i ? o[1] : o[0],
                            c = "right" === a ? n[1] : n[0];
                        ...
                        return s === ("left" === (0, l.getDirectionFromFaces)(r.getFaceOfColor(s), r.getFaceOfColor("u"), {
                            up: "down"
                        }) ? t.getColorOfFace(c) : t.colors().find(function(e) {
                    ...
                    value: function(e) {
                        ...
                        var c = t.faces(),
                            ...
                            v = s[0],
                            m = s[1],
                            h = (0, l.getDirectionFromFaces)(v, m, {
                                up: "down"
                            }),
                            p = "right" === h ? m : v;
                        this.move(p + " DPrime " + f(p), {
                            upperCase: !0
                        }), this.solveMatchedPair({
                            corner: r,
                            edge: t
                    ...
                    value: function(e) {
                        ...
                        var a = (0, l.getDirectionFromFaces)(t.faces()[0], t.faces()[1], {
                                up: "down"
                            }),
                            u = t.faces()["right" === a ? 1 : 0];
                        this.move(u + " D " + f(u) + " DPrime", {
                            upperCase: !0
                        }), this.move(u + " D " + f(u), {
                            upperCase: !0
                        }), this.solveSeparatedPair({
                    ...
                    value: function(e, r) {
                        var t = e.corner,
                            ...
                            a = 3 === r ? i : n,
                            u = "left" === (0, l.getDirectionFromFaces)(t.getFaceOfColor(i), t.getFaceOfColor("u"), {
                                up: "down"
                            }),
                            ...
                            m = u ? s : f(s),
                            h = u ? "DPrime" : "D";
                        h = 4 === r ? f(h) : h, this.move(v + " " + m + " " + h + " " + f(m), {
                            upperCase: !0
                        }), this["solve" + (3 === r ? "Matched" : "Separated") + "Pair"]({
                            corner: t,
                            edge: o
                        })
                    }
                ...
                return i(r, e), u(r, [{
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            n = (0, l.getDirectionFromFaces)(o[0], o[1], {
                                up: "down"
                            }),
                            ...
                            h = (0, l.getFaceFromDirection)(r.getFaceOfColor(m), m === r.getColorOfFace(s) ? "right" : "left", {
                                up: "down"
                            }),
                    ...
                    value: function(e) {
                        var r = e.corner,
                            ...
                            s = "left" === (0, l.getDirectionFromFaces)(r.getFaceOfColor(o), r.getFaceOfColor("u"), {
                                up: "down"
                            }),
                            v = s ? "DPrime" : "D",
                            m = r.getFaceOfColor("u");
                        m = s ? f(m) : m, this.move(c + " " + m + " " + v + " " + f(m), {
                            upperCase: !0
                        }), this["solve" + (a ? "Matched" : "Separated") + "Pair"]({
                            corner: r,
                            edge: t
                        })
                    }
